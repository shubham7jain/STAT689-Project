...
plt.plot(noise_levels, pE1_SF, 'b--', label='SF')
plt.plot(noise_levels, pE1_MF, 'g--', label='MF')
plt.plot(noise_levels, pE1_CF, 'y--', label='CF')
plt.title("Probability of Error E1 with varying noise levels")
plt.xlabel("Noise Level")
plt.ylabel("P(E1)")
plt.legend(loc='upper right')
plt.show()

plt.plot(noise_levels, pE2_SF, 'b--', label='SF')
plt.plot(noise_levels, pE2_MF, 'g--', label='MF')
plt.plot(noise_levels, pE2_CF, 'y--', label='CF')
plt.title("Probability of Error E2 with varying noise levels")
plt.xlabel("Noise Level")
plt.ylabel("P(E2)")
plt.legend(loc='upper right')
plt.show()